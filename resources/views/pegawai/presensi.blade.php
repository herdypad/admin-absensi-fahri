                ...
                <div class="p-5 bg-white rounded-3">
                    ...
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="">
                                <button class="btn btn-primary" type=button onClick="startCamera(this)">Mulai Kamera</button>
                                @if(!isset($presensi->jam_masuk))
                                <button id="btn-presensi" class="btn btn-success">Presensi</button>
                                @else
                                <button id="btn-presensi" class="btn btn-warning">Presensi</button>
                                @endif
                            </div>
                        </div>
                        @if (!isset($presensi->jam_masuk))
